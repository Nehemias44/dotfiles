...
(let ((base    "#191724")
  ...
  (custom-theme-set-faces
     ...
     `(fixed-pitch    ((t (:family "Iosevka SS07" :weight light :height 140))))

     `(org-level-8 ((t (:family "Iosevka SS07" :weight normal :foreground ,love))))
     `(org-level-7 ((t (:family "Iosevka SS07" :weight normal :foreground ,iris))))
     `(org-level-6 ((t (:family "Iosevka SS07" :weight normal :foreground ,rose))))
     `(org-level-5 ((t (:family "Iosevka SS07" :weight normal :foreground ,gold))))
     `(org-level-4 ((t (:family "Iosevka SS07" :weight normal :foreground ,foam))))
     `(org-level-3 ((t (:family "Iosevka SS07" :weight normal :foreground ,pine))))
     `(org-level-2 ((t (:family "Iosevka SS07" :weight normal :foreground ,love))))
     `(org-level-1 ((t (:family "Iosevka SS07" :weight normal :foreground ,iris))))
